    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-white">
      <div className="flex flex-row justify-between items-center px-4 py-3">
        <div className="flex flex-row items-center">
          <div className="min-w-10 min-h-10 hover:rounded-full hover:bg-gray-100 cursor-pointer">
            <img
              className="min-h-6 min-w-5 mt-2 ml-2"
          ...
          <div className="flex flex-row relative">
            <form className="flex" onSubmit={handleSubmit}>
              <input
                ...
                className="border rounded-l-full w-40 sm:w-60 md:w-80 lg:w-[500px] h-10 pl-5 outline-none"
                type="text"
                placeholder="Search"
              />
              <button
                type="submit"
                className="border rounded-r-full w-16 h-10 bg-gray-100"
              >
                <img
                  alt="search-icon"
            ...
            <div className="hidden md:block w-10 h-10 hover:rounded-full hover:bg-gray-100 ml-5 cursor-pointer">
        ...
        <div className="flex flex-row-reverse justify-around">
          ...
          <div className="hidden lg:block w-10 h-10 hover:rounded-full hover:bg-gray-100 ml-5 cursor-pointer relative">
          ...
          <div className="hidden lg:block w-10 h-10 hover:rounded-full hover:bg-gray-100 ml-5 cursor-pointer">
